...
> **Note:** Native platform-specific versions of JMedia (Windows .exe, macOS .app, Linux binaries) will not require Java pre-installation.
...
For more information, visit the JMedia project documentation.