...
if ('mediaSession' in navigator) {
    ...
    window.updateMediaSessionMetadata = (songName, artist, artworkUrl) => {
        ...
        console.log("[mediaSession.js] Media Session metadata updated.");
    };

    // Function to update Media Session playback state
    window.updateMediaSessionPlaybackState = (isPlaying) => {
        navigator.mediaSession.playbackState = isPlaying ? 'playing' : 'paused';
        console.log("[mediaSession.js] Media Session playback state updated to:", navigator.mediaSession.playbackState);
    };
